...
public class Snodo{
	...
	*/
	...
	/**Calcula el equilibrio del nodo, este resultado sera:
	   -2 : cuando tiene m�s nodos a la izq que a la derecha, puede haber error al agregar otro a la izquierda
	   -1 : cuando tiene un nodo m�s a la izq que a la derecha
	    0 : cuando hay la misma cantidad de nodos a la derecha que a la izquierda, por lo que puede haber un error en la siguiente inserci�n
	    1 : cuando tiene un nodo m�s a la derecha que a la izquierda
	    2 : cuando tiene m�s nodos a la der que a la izquierda, puede haber error al agregar otro a la derecha
